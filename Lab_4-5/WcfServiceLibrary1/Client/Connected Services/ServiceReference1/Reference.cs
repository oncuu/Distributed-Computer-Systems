...
namespace Client.ServiceReference1 {
    ...
    public interface IService1 {
        ...
        [System.ServiceModel.OperationContractAttribute(IsOneWay=true, Action="http://tempuri.org/IService1/LaunchTheNukes")]
        void LaunchTheNukes();
        
        [System.ServiceModel.OperationContractAttribute(IsOneWay=true, Action="http://tempuri.org/IService1/LaunchTheNukes")]
        System.Threading.Tasks.Task LaunchTheNukesAsync();
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IService1Callback {
        
        [System.ServiceModel.OperationContractAttribute(IsOneWay=true, Action="http://tempuri.org/IService1/NumberOfNukesLaunched")]
    ...
    public partial class Service1Client : System.ServiceModel.DuplexClientBase<Client.ServiceReference1.IService1>, Client.ServiceReference1.IService1 {
        ...
        public void LaunchTheNukes() {
            base.Channel.LaunchTheNukes();
        }
        
        public System.Threading.Tasks.Task LaunchTheNukesAsync() {
            return base.Channel.LaunchTheNukesAsync();
        }

        internal Task<bool> AddNumberAsync(int v1, int v2)
        {
            throw new NotImplementedException();
        }

        internal Task<string> DivNumberAsync(int num1, int num2)
        {
            throw new NotImplementedException();
        }

        internal Task<string> MultNumberAsync(int num1, int num2)
        {
            throw new NotImplementedException();
        }

        internal Task<string> ShowDataAsync(int age)
        {
            throw new NotImplementedException();
        }

        internal Task<string> SubNumberAsync(int num1, int num2)
        {
            throw new NotImplementedException();
        }
    }
